...
import { IRecord, IUser, IUserDetail, User } from "~/types";
...
export type OwnRecord = Omit<IRecord, 'approvalsId' | 'category' | 'status'> & { totalPlay: number };
...
export type EtmContractDetail =
    Omit<EtmContract, 'createdBy' | 'usersId'> &
    { createdBy: User; user: User & { status: string } };
