...
import { QUARTERLY, Quarter, formatDateYMD, formatMoney } from "~/constants";
import { SidebarContext } from "~/context/Sidebar/SidebarContext.index";
import { RootState, useAppDispatch } from "~/state";
import { getEtmContractForControls } from "~/state/thunk/entrustmentContractThunk";
...
function RevenueReportPage() {
    ...
    const [contracts, setContracts] = useState<Array<EtmContractForControl & { recordPlay: Array<IRecordPlay> }>>([] as Array<EtmContractForControl & { recordPlay: Array<IRecordPlay> }>);
